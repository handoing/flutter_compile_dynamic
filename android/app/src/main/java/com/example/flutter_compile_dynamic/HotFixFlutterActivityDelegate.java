...
public class HotFixFlutterActivityDelegate implements FlutterActivityEvents, FlutterView.Provider, PluginRegistry {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!this.loadIntent(this.activity.getIntent())) {
            String appBundlePath = MyFlutterMain.findAppBundlePath(this.activity.getApplicationContext());
    ...
    private boolean loadIntent(Intent intent) {
        ...
        if ("android.intent.action.RUN".equals(action)) {
            ...
            if (appBundlePath == null) {
                appBundlePath = MyFlutterMain.findAppBundlePath(this.activity.getApplicationContext());
            }
